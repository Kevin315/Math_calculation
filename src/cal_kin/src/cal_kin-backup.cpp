...
int main(int argc, char* argv[])
{
	...
	MatrixXd ee_position_A(4,4), ee_position_B(4,4), ee_position_C(4,4), ee_position_D(4,4);
	MatrixXf Trans(4,4);
...
0,  0,  0,  1; 
	...
	ee_position_B << -0.808496, -0.000468639,  -0.588501,  -0.350767,
-0.588501,  -0.000643827, 0.808496,  0.201816,
0,  1,  -0.000796327,  0.365082,
0,  0,  0,  1; 

	ee_position_C << -0.808496, -0.000468639,  -0.588501,  -0.350767,
-0.588501,  -0.000643827, 0.808496,  0.251816,
0,  1,  -0.000796327,  0.365082,
0,  0,  0,  1; 

	ee_position_D<<1, 0,  0,  -0.20767,
0,  1, 0,  0.151816,
0,  0, 1,  0.255082,
0,  0,  0,  1; 

	//cout<<ee_position<<endl;
	//double q[6] = {0.0, 0.0, 1.0, 0.0, 1.0, 0.0};
	//double q[6] = {2.2, 0, -1.57, 0, 0, 0};
	double q[6] = {1.5,-0.2,-1.57,0,0,0};
	double* T = new double[16];
/*
  T[0] = -0.808; T[1] = -0.000;  T[2] = -0.589; T[3] = -0.351;
  T[4] = -0.589; T[5] =  0.001;  T[6] = 0.808;  T[7] =0.152;
  T[8] = 0.000;  T[9] = 1.000;   T[10] = -0.001; T[11] = 0.365;
  T[12] = 0.000; T[13] = 0.000;T[14] = 0.000; T[15] = 1.000;*/
